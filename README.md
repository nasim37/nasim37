![Nasim Uddin Khan — Software Developer](https://github.com/user-attachments/assets/ccbd0cfb-37f8-4c11-b972-d57201937e9e)

# Md. Nasim Uddin Khan

### Software Developer · Product Builder · Mobile & Web Engineer
...
### A social travel companion for people, places, and shared journeys

TravelMate is a Flutter-based mobile application designed around the complete travel experience—not just destination discovery. It brings together travel packages, bookings, buddy and guide discovery, community content, messaging, calls, notifications, and shared trip expenses in one connected product.

**What I built into the experience**

- Authentication flows including email, phone, OTP, password recovery, Google Sign-In, and onboarding.
- Travel package discovery with details, itineraries, highlights, galleries, reviews, and booking flows.
- Buddy and guide discovery with filters, profiles, social connections, and guide booking.
...
![Riverpod](https://img.shields.io/badge/Riverpod-2D3748?style=flat-square&logo=dart&logoColor=white)
...
> Personal student data stays in PostgreSQL. The blockchain stores only the certificate identity, hash, issuer, status, and timestamp needed for verification.
